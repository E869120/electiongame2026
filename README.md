...
なお、難易度が上がるにつれ、最初の資金・協力者数等が不利になるだけでなく、AI も強くなります。特に、「難しい」以上のモードでは 3 つの政党から始まり、途中で AI 連合に合併するという仕様になっています (詳細は 3.5 節を参照)。
...
難易度「難しい」「とても難しい」では、プレイヤーの他に「AI 新党」「GPT 党」という 2 つの政党があり、GPT 党は固定で組織票の 40 議席分を持っています。選挙戦の 5 日目に入ると、突然その 2 つの党が合併され「AI 連合」になります。さらに、それと同時に相手の協力者が 170 人増えます。
